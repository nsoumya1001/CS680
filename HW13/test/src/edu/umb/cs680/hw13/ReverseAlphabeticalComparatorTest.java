...
public class ReverseAlphabeticalComparatorTest {
    ...
    public void ReverseAlphabeticalSortingUnderRepoTest(){
        ...
        for(FSElement e: fs.getRootDirs().getFirst().getSubDirectories(new ReverseAlphabeticalComparator())){
    ...
    public void ReverseAlphabeticalSortingUnderSrcTest(){
        List<String> actual= new ArrayList<> ();
        for(FSElement e: fs.getRootDirs().getFirst().getSubDirectories ().getFirst ().getFiles (new ReverseAlphabeticalComparator ())){
            actual.add(e.getName());}
